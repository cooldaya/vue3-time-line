...
var Be = Se.exports;
const K = /* @__PURE__ */ Ae(Be);
const _e = (a, Y) => {
  const W = a.__vccOpts || a;
  for (const [n, O] of Y)
    W[n] = O;
  return W;
}, Ne = { class: "order" }, Xe = /* @__PURE__ */ Object.assign({ name: "WindowListItem" }, {
  ...
  setup(a, { expose: Y, emit: W }) {
    ...
    return Me(() => {
      ...
      class: Ce(["windowListItem", { active: a.active }]),
      ref_key: "windowListItem",
      ref: k,
      onClick: te
    }, [
      ge("span", Ne, Oe(a.index + 1), 1),
      ge("canvas", {
...
}), je = /* @__PURE__ */ _e(Xe, [["__scopeId", "data-v-35f19113"]]), we = 60 * 60 * 1e3, ee = [0.5, 1, 2, 6, 12, 24, 72, 360, 720, 8760, 87600], ve = [1 / 60, 1 / 60, 2 / 60, 1 / 6, 0.25, 0.5, 1, 4, 4, 720, 7200], pe = [
  1 / 20,
  1 / 30,
  1 / 20,
  1 / 3,
...
const ze = /* @__PURE__ */ Object.assign({ name: "TimeLine" }, {
  __name: "TimeLine",
  props: {
  ...
  setup(a, { expose: Y, emit: W }) {
    ...
    }), I = oe(() => n.isMobile ? pe : ve), te = oe(() => n.isMobile ? Fe : Ue), Z = oe(() => e.currentZoomIndex === 9), B = oe(() => e.currentZoomIndex === 10), D = () => {
    ...
    const ue = (t) => {
      ...
      T && T.length > 0 ? O("click_timeSegments", T, h, S, t) : De(h, S, t);
    }, _ = (t, o) => {
      let c = [];
      return se((h) => {
    ...
    return Ie(() => n.timeSegments, J, { deep: !0 }), Me(() => {
      ...
      ge("canvas", {
        ...
        ref_key: "canvas",
        ref: L,
        onMousewheel: He(v, ["stop", "prevent"])
      }, null, 544),
      e.showWindowList && a.windowList && a.windowList.length > 1 ? (le(), de("div", {
        ...
        (le(!0), de(Ye, null, Ze(e.windowListInner, (c, h) => (le(), Ee(je, {
          ref_for: !0,
...
}), xe = /* @__PURE__ */ _e(ze, [["__scopeId", "data-v-55d6c60f"]]), Ve = {
  install(a, Y) {
